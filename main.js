...
function createWindow () {
  ...
  // de-reference the mainWindow object when the window is closed
...
app.on('activate', function () {
  // re-create the mainWindow if the dock icon is clicked in OS X and no other windows were open
  if (mainWindow === null) {
    createWindow();
  }
});
